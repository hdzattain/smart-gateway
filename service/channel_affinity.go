...
const (
	...
	channelAffinityCacheNamespace           = "smart-gateway:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "smart-gateway:channel_affinity_usage_cache_stats:v1"
)
