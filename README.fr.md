...
<p align="center">
  <a href="https://raw.githubusercontent.com/hdzattain/smart-gateway/main/LICENSE">
    <img src="https://img.shields.io/github/license/hdzattain/smart-gateway?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/hdzattain/smart-gateway/releases/latest">
    <img src="https://img.shields.io/github/v/release/hdzattain/smart-gateway?color=brightgreen&include_prereleases" alt="version">
  </a><!--
...
<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=smart-gateway">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://smart-gateway.shop/docs/en/docs/installation)
...
### 📖 [Documentation officielle](https://smart-gateway.shop/docs/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/hdzattain/smart-gateway)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://smart-gateway.shop/docs/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://smart-gateway.shop/docs/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://smart-gateway.shop/docs/en/docs/api) |
| ❓ FAQ | [FAQ](https://smart-gateway.shop/docs/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://smart-gateway.shop/docs/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://smart-gateway.shop/docs/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
| 🔄 Compatibilité des données | Complètement compatible avec la base de données originale de Smart Gateway |
...
- 🔍 Requête de quota d'utilisation de clé (avec [Smart Gateway key tool](https://https://smart-gateway.shop))

### 🚀 Fonctionnalités avancées

**Prise en charge des formats d'API:**
- ⚡ [OpenAI Responses](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://smart-gateway.shop/docs/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
- ⚡ [Claude Messages](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://smart-gateway.shop/docs/en/api/google-gemini-chat)
- 🔄 [Modèles Rerank](https://smart-gateway.shop/docs/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de passerelle](https://smart-gateway.shop/docs/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [Documentation](https://smart-gateway.shop/docs/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [Documentation](https://smart-gateway.shop/docs/api/suno-music) |
| 🔄 Rerank | Cohere, Jina | [Documentation](https://smart-gateway.shop/docs/en/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Format Messages | [Documentation](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://smart-gateway.shop/docs/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://smart-gateway.shop/docs/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://smart-gateway.shop/docs/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://smart-gateway.shop/docs/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://smart-gateway.shop/docs/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://smart-gateway.shop/docs/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://smart-gateway.shop/docs/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **Dernière image Docker:** `hdzattain/smart-gateway:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `smart-gateway` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `smart-gateway` |

📖 **Configuration complète:** [Documentation des variables d'environnement](https://smart-gateway.shop/docs/en/docs/installation/config-maintenance/environment-variables)
...
2. Recherchez **Smart-Gateway** dans le magasin d'applications
...
| Projet | Description |
|------|------|
| [Smart Gateway](https://smart-gateway.shop) | Base du projet original |
...
| Projet | Description |
|------|------|
| [Smart Gateway key tool](https://https://smart-gateway.shop) | Outil de recherche de quota d'utilisation avec une clé |
| [Smart Gateway Horizon](https://https://smart-gateway.shop) | Version optimisée haute performance de Smart Gateway |
...
| 📘 FAQ | [FAQ](https://smart-gateway.shop/docs/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://smart-gateway.shop/docs/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://smart-gateway.shop/docs/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://smart-gateway.shop/docs/en/docs) |
...
Il s'agit d'un projet open-source développé sur la base de [Smart Gateway](https://smart-gateway.shop) (licence MIT).

Si les politiques de votre organisation ne permettent pas l'utilisation de logiciels sous licence AGPLv3, ou si vous souhaitez éviter les obligations open-source de l'AGPLv3, veuillez nous contacter à : [support@smart-gateway.shop](mailto:support@smart-gateway.shop)
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=hdzattain/smart-gateway&type=Date)](https://star-history.com/#hdzattain/smart-gateway&Date)
...
### 💖 Merci d'utiliser Smart Gateway

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://smart-gateway.shop/docs/en/docs)** • **[Commentaires sur les problèmes](https://github.com/hdzattain/smart-gateway/issues)** • **[Dernière version](https://github.com/hdzattain/smart-gateway/releases)**

<sub>Construit avec ❤️ par Smart Gateway</sub>
