...
import (
	...
	"github.com/hdzattain/smart-gateway/pkg/cachex"
...
const (
	subscriptionPlanCacheNamespace     = "smart-gateway:subscription_plan:v1"
	subscriptionPlanInfoCacheNamespace = "smart-gateway:subscription_plan_info:v1"
)
...
type SubscriptionPlan struct {
	...
	LongyueProductId      string `json:"longyue_product_id" gorm:"type:varchar(128);default:''"`
