...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  50: 'Format: AccessKey|SecretKey (or just ApiKey if upstream is Smart Gateway)',
...
export const CHANNEL_TYPE_WARNINGS: Record<number, string> = {
  ...
  8: 'If connecting to upstream Smart Gateway or Smart Gateway relay projects, use OpenAI type instead unless you know what you are doing',
