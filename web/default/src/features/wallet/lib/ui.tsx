...
export function getPaymentIcon(
  ...
  switch (paymentType) {
    ...
    case PAYMENT_TYPES.MCT_PAY:
      return (
        <CreditCard
          className={className}
          style={{ color: PAYMENT_ICON_COLORS[PAYMENT_TYPES.MCT_PAY] }}
        />
      )
    ...
    case PAYMENT_TYPES.LONGYUE:
      return (
        <CreditCard
          className={className}
          style={{ color: PAYMENT_ICON_COLORS[PAYMENT_TYPES.LONGYUE] }}
        />
      )
