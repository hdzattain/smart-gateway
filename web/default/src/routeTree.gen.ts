...
import { Route as AiDealsIndexRouteImport } from './routes/ai-deals/index'
...
const AiDealsIndexRoute = AiDealsIndexRouteImport.update({
  id: '/ai-deals/',
  path: '/ai-deals/',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/ai-deals/': typeof AiDealsIndexRoute
...
export interface RootRouteChildren {
  ...
  AiDealsIndexRoute: typeof AiDealsIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/ai-deals/': {
      ...
      path: '/ai-deals'
      fullPath: '/ai-deals/'
      preLoaderRoute: typeof AiDealsIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/about/': {
      id: '/about/'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  AiDealsIndexRoute: AiDealsIndexRoute,
