...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-smart-gateway-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-smart-gateway-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-smart-gateway-container') return true;
      return (
