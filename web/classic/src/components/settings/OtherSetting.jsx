...
const OtherSetting = () => {
  ...
  const checkUpdate = async () => {
    try {
      ...
      //   `${proxyUrl}https://api.github.com/repos/hdzattain/smart-gateway/releases/latest`,
      // );
      ...
      const res = await fetch(
        'https://api.github.com/repos/hdzattain/smart-gateway/releases/latest',
        {
          headers: {
            ...
            'User-Agent': 'smart-gateway-update-checker',
          },
        },
  ...
  const openGitHubRelease = () => {
    window.open(
      `https://github.com/hdzattain/smart-gateway/releases/tag/${updateData.tag_name}`,
      '_blank',
    );
  };
          ...
          <Card>
            <Form.Section text={t('个性化设置')}>
              ...
              <Banner
                ...
                type='info'
                description={t(
                  '移除 Smart Gateway 的版权标识必须首先获得授权，项目维护需要花费大量精力，如果本项目对你有意义，请主动支持本项目',
                )}
                closeIcon={null}
                style={{ marginTop: 15 }}
              />
