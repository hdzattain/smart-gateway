              ...
              <Card>
                <Form.Section text={t('代理设置')}>
                  ...
                  <Text>
                    {t('仅支持')}{' '}
                    <a
                      href='https://github.com/hdzattain/smart-gateway-worker'
                      target='_blank'
                      rel='noreferrer'
                    >
                      smart-gateway-worker
                    </a>{' '}
                    {t('或其兼容smart-gateway-worker格式的其他版本')}
                  </Text>
                  <Row
                    gutter={{ xs: 8, sm: 16, md: 24, lg: 24, xl: 24, xxl: 24 }}
                  >
                  ...
                  >
                    <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                      <Form.Input
                        ...
                        extraText={t(
                          '为空则默认使用服务器地址，多个 Origin 用逗号分隔，例如 https://smart-gateway.shop,https://www.smart-gateway.shop ,注意不能携带[]，需使用https',
                        )}
                      />
                    </Col>
                  </Row>
