...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=smart-gateway">JetBrains</a> 為本項目提供免費的開源開發許可證</strong>
</p>
...
📖 更多部署方式請參考 [部署指南](https://smart-gateway.shop/docs/installation)
...
### 📖 [官方文件](https://smart-gateway.shop/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/hdzattain/smart-gateway)
...
| 分類 | 連結 |
|------|------|
| 🚀 部署指南 | [安裝文件](https://smart-gateway.shop/docs/installation) |
| ⚙️ 環境配置 | [環境變數](https://smart-gateway.shop/docs/installation/config-maintenance/environment-variables) |
| 📡 接口文件 | [API 文件](https://smart-gateway.shop/docs/api) |
| ❓ 常見問題 | [FAQ](https://smart-gateway.shop/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://smart-gateway.shop/docs/support/community-interaction) |

---

## ✨ 主要特性

> 詳細特性請參考 [特性說明](https://smart-gateway.shop/docs/guide/wiki/basic-concepts/features-introduction)
...
- 📱 Telegram 授權登錄
- 🔑 OIDC 統一認證
- 🔍 Key 查詢使用額度（配合 [Smart Gateway key tool](https://https://smart-gateway.shop)）

### 🚀 高級功能

**API 格式支援：**
- ⚡ [OpenAI Responses](https://smart-gateway.shop/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://smart-gateway.shop/docs/api/ai-model/realtime/create-realtime-session)（含 Azure）
- ⚡ [Claude Messages](https://smart-gateway.shop/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://smart-gateway.shop/docs/api/google-gemini-chat)
- 🔄 [Rerank 模型](https://smart-gateway.shop/docs/api/ai-model/rerank/create-rerank)（Cohere、Jina）
...
> 詳情請參考 [接口文件 - 閘道接口](https://smart-gateway.shop/docs/api)

| 模型類型 | 說明 | 文件 |
|---------|------|------|
| 🤖 OpenAI-Compatible | OpenAI 兼容模型 | [文件](https://smart-gateway.shop/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | OpenAI Responses 格式 | [文件](https://smart-gateway.shop/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [文件](https://smart-gateway.shop/docs/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [文件](https://smart-gateway.shop/docs/api/suno-music) |
| 🔄 Rerank | Cohere、Jina | [文件](https://smart-gateway.shop/docs/api/ai-model/rerank/create-rerank) |
| 💬 Claude | Messages 格式 | [文件](https://smart-gateway.shop/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Google Gemini 格式 | [文件](https://smart-gateway.shop/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | ChatFlow 模式 | - |
...
- [聊天接口 (Chat Completions)](https://smart-gateway.shop/docs/api/ai-model/chat/openai/createchatcompletion)
- [響應接口 (Responses)](https://smart-gateway.shop/docs/api/ai-model/chat/openai/createresponse)
- [圖像接口 (Image)](https://smart-gateway.shop/docs/api/ai-model/images/openai/post-v1-images-generations)
- [音訊接口 (Audio)](https://smart-gateway.shop/docs/api/ai-model/audio/openai/create-transcription)
- [影片接口 (Video)](https://smart-gateway.shop/docs/api/ai-model/audio/openai/createspeech)
- [嵌入接口 (Embeddings)](https://smart-gateway.shop/docs/api/ai-model/embeddings/createembedding)
- [重排序接口 (Rerank)](https://smart-gateway.shop/docs/api/ai-model/rerank/creatererank)
- [即時對話 (Realtime)](https://smart-gateway.shop/docs/api/ai-model/realtime/createrealtimesession)
- [Claude 聊天](https://smart-gateway.shop/docs/api/ai-model/chat/createmessage)
- [Google Gemini 聊天](https://smart-gateway.shop/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **最新版 Docker 鏡像：** `hdzattain/smart-gateway:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscope 應用名                                        | `smart-gateway` |
...
| `HOSTNAME` | Pyroscope 標籤裡的主機名                                          | `smart-gateway` |

📖 **完整配置：** [環境變數文件](https://smart-gateway.shop/docs/installation/config-maintenance/environment-variables)
...
| 項目 | 說明 |
|------|------|
| [Smart Gateway](https://smart-gateway.shop) | 原版項目基礎 |
...
| 項目 | 說明 |
|------|------|
| [Smart Gateway key tool](https://https://smart-gateway.shop) | Key 額度查詢工具 |
| [Smart Gateway Horizon](https://https://smart-gateway.shop) | Smart Gateway 高性能優化版 |
...
| 📘 常見問題 | [FAQ](https://smart-gateway.shop/docs/support/faq) |
| 💬 社群交流 | [交流管道](https://smart-gateway.shop/docs/support/community-interaction) |
| 🐛 回饋問題 | [問題回饋](https://smart-gateway.shop/docs/support/feedback-issues) |
| 📚 完整文件 | [官方文件](https://smart-gateway.shop/docs) |
...
本項目為開源項目，在 [Smart Gateway](https://smart-gateway.shop)（MIT 許可證）的基礎上進行二次開發。

如果您所在的組織政策不允許使用 AGPLv3 許可的軟體，或您希望規避 AGPLv3 的開源義務，請發送郵件至：[support@smart-gateway.shop](mailto:support@smart-gateway.shop)
...
**[官方文件](https://smart-gateway.shop/docs)** • **[問題回饋](https://github.com/hdzattain/smart-gateway/issues)** • **[最新發布](https://github.com/hdzattain/smart-gateway/releases)**
