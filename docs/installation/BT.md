...
本文档提供使用宝塔面板 Docker 功能部署 Smart Gateway 的图文教程。

> 📖 官方文档：[宝塔面板部署](https://smart-gateway.shop/docs/installation/deployment-methods/bt-docker-installation)
...
## 步骤三：安装 Smart Gateway

### 方法一：使用宝塔应用商店（推荐）

1. 在宝塔面板 Docker 功能中，点击 **应用商店**
2. 搜索并找到 **Smart-Gateway**
3. 点击 **安装**
4. 配置以下基本选项：
   - **容器名称**：可自定义，默认为 `smart-gateway`
   - **端口映射**：默认为 `3000:3000`
   - **环境变量**：
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/smart-gateway`
...
services:
  smart-gateway:
    image: hdzattain/smart-gateway:latest
...
- [官方文档](https://smart-gateway.shop/docs/installation)
- [环境变量配置](https://smart-gateway.shop/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://smart-gateway.shop/docs/support/faq)
- [GitHub 仓库](https://github.com/hdzattain/smart-gateway)
