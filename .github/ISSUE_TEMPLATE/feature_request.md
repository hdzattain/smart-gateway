...
- 使用问题先看或先问：https://deepwiki.com/hdzattain/smart-gateway
...
[//]: # (方框内删除已有的空格，填 x 号)
- [ ] **非重复 issue:** 我已搜索现有 [Issues](https://github.com/hdzattain/smart-gateway/issues?q=is%3Aissue)，确认目前没有类似 issue。
